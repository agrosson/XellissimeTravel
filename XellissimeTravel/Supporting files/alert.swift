...
class Alert{
    ...
    private func presentAlert(myCase : listCase){
        ...
        case .weatherRequestFailed:
            controller?.presentAlertDetails(title: "Sorry", message: "The request to get weather forecast failed.", titleButton: "OK")
        case .changeRequestFailed :
            controller?.presentAlertDetails(title: "Sorry", message: "The request to get FX failed.", titleButton: "OK")
        case .translationRequestFailed:
            controller?.presentAlertDetails(title: "Sorry", message: "The request to translate failed.", titleButton: "OK")
        case .bigAmount:
            controller?.presentAlertDetails(title: "Sorry", message: "The amount to change is to big. Change your data", titleButton: "OK")
        case .emptyText:
            controller?.presentAlertDetails(title: "Sorry", message: "Your text is empty", titleButton: "OK")
        }
    }
}
